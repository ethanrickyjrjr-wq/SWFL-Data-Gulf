...
**Fixed platform floor:** RESOLVED by operator 07/02/2026 — we are on the FIRST tier of each plan: Vercel Hobby $0, Supabase Free $0, Resend Free $0 (3,000 emails/mo, 100 emails/day cap), staying on Resend Free until launch forces the upgrade. Fixed cash floor today ≈ $0 + daily brain-rebuild LLM spend — [INFERENCE] ≈ $20/mo (32 Sonnet calls/day × measured $0.0213/call avg); falsifier: rebuild calls carry much larger inputs than deliverable builds — reconcile against the ops /spend page before trusting. LAUNCH TRIGGER: Resend Free's 100/day cap supports the free tier (50 sends/mo/user) but NOT paid tiers — the first Starter customer (500 sends/mo ≈ 17/day sustained, bursty in practice) requires Resend Pro $20/mo; wire the upgrade into the Stripe go-live checklist (Lane A).
