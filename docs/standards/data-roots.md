...
- STATUS: 🔴 **not built** (intended home, never a served number — table does not exist yet; `to_regclass` → NULL verified 08/02/2026). Build check: `steadyapi_pth_raw_landing_before_backfill`.
