...
export const TEMPLATE_MANIFEST: TemplateEntry[] = [
  ...
  {
    slug: "viz/franchise-survival",
    family: "viz",
    id: "002",
    name: "Franchise survival",
    subtitle: "SBA 7(a)/504 outcomes, ranked",
    description:
      "Sortable ranked bars of franchise-brand survival across resolved SBA loans, with a pack-median marker. Click any brand for charge-off rate, sample size, and gross approval.",
    tokenType: "FranchiseSurvivalTokens",
    previewData: {
      brands_assessed: 14,
      brands_corpus_sub: "of 15 in corpus",
      resolved_loans: 169,
      resolved_detail: "132 paid · 37 charged off",
      overall_survival: "78.1%",
      gross_approval: "$68.4M",
      gross_approval_sub: "across 15 brands",
      pack_median: "76.25%",
