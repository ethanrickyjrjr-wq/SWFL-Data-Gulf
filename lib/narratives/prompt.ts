...
export function buildNarrativePrompt(inputs: BakeInputs): { system: string; user: string } {
  ...
  const system = [
    ...
    "3. Narration: 2–3 short paragraphs (roughly 600–1200 characters) on what most sets",
    "   this area apart right now and what just moved, weaving the strongest signals",
    "   together. Conversational, concrete, zero filler.",
