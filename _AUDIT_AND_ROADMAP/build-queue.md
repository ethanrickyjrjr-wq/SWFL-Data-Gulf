...
- [~] Assembly engine + hosted deliverable — `POST /api/projects/[id]/build` (forced-tool LLM) + `/p/[id]` public page; deterministic jargon scrub; restyle-without-re-LLM (S6). Now built via the **Presentation Deliverable Engine** plan (`docs/superpowers/plans/2026-06-10-presentation-deliverable-engine/`, 7 phases): Phase 0 ✅ render proven (2026-06-10), Phase 1 (keystone as-of) next.
