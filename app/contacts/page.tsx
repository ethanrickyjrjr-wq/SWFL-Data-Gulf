  ...
  return (
    <PageShell className="py-8">
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="rounded-lg bg-gulf-teal px-3 py-1.5 text-sm font-medium text-[#0a1419] hover:bg-gulf-teal/80"
          >
            Add contact
          </button>
        </div>
      ...
      <input
        ...
        className="mb-4 w-full rounded-lg border border-white/10 bg-[#0d1e2b] px-3 py-2 text-sm text-white placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-gulf-teal"
      />
      ...
      {allTags.length > 0 && (
        <div className="mb-4 flex flex-wrap gap-2">
          <button
            ...
            className={`rounded-full px-3 py-1 text-xs font-medium ${!activeTag ? "bg-gulf-teal text-[#0a1419]" : "border border-white/10 text-gray-400 hover:text-white"}`}
          >
            All
          </button>
          {allTags.map((tag) => (
            <button
              ...
              className={`rounded-full px-3 py-1 text-xs font-medium ${activeTag === tag ? "bg-gulf-teal text-[#0a1419]" : "border border-white/10 text-gray-400 hover:text-white"}`}
            >
              {tag}
            </button>
          ))}
            ...
            <form onSubmit={handleAdd} className="space-y-3">
              ...
              <div className="flex justify-end gap-3 pt-2">
                ...
                <button
                  type="submit"
                  disabled={busy}
                  className="rounded-lg bg-gulf-teal px-4 py-2 text-sm font-medium text-[#0a1419] disabled:opacity-50"
                >
