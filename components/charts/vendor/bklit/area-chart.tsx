...
export interface AreaChartProps {
   ...
   *  `ParentSize` (0×0 under `ReactDOMServer.renderToStaticMarkup`). Only the
   *  static/email render bridge passes this — see `render-static.tsx`. */
...
export function AreaChart({
  ...
  if (staticSize) {
    return (
      <div className={cn("relative w-full", className)} style={{ aspectRatio, ...style }}>
        <ChartInner
          animationDuration={animationDuration}
          animationEasing={animationEasing}
          chartStatus={status}
