...
export function FirstTouchHint() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-4 z-[55] flex justify-center px-4">
      <div className="glass-card-modern pointer-events-auto flex max-w-sm items-center gap-3 rounded-full border border-white/10 px-4 py-2.5 text-sm text-gray-200 shadow-xl shadow-black/40">
        <span className="text-[#00d4aa]">✦</span>
        <span className="min-w-0">
          Tap any figure or place to ask about it or chart it.
        </span>
        <button
          type="button"
          onClick={dismiss}
