 ...
 * slug (27 entries — 18 Lee, 9 Collier). The permits-swfl pack identifies
 * corridors by centroid `corridor_id` (27 entries, Lee + Collier; see
...
> = {
  ...
  "joel-blvd-lehigh-acres": "joel-blvd-lehigh-acres",
