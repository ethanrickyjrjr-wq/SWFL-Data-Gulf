<!-- FRESHNESS: v32 | Token: SWFL-7421-v32-20260802-d7137047 -->
---
brain_id: freshness-pulse
version: 32
refined_at: 2026-08-02T04:29:11Z
freshness_token: SWFL-7421-v32-20260802-d7137047
ttl_seconds: 86400
...
s01 | SWFL daily freshness layer — one cited current number per (metric, area) from a grounded live search (Gemini grounded → Firecrawl failsafe), provenance-gated to a real source URL, via Supabase data_lake.daily_truth (metric_key, area, period, value, unit, source_url, source_title, source_tag, verified_on_page, agreement_n, anomaly_flag, retrieved_at). | 2026-08-02 | 2026-08-03

--- SAVED FACTS ---
[
  {"id":"f001","topic":"freshness :: median_asking_price :: cape_coral","fact":"Cape Coral median asking price (sourced 2026-08-02)","value":"399900 usd as of 2026-08-02, source SWFL Data Gulf active-listing inventory (https://www.swfldatagulf.com/desk).","src":"s01","date":"2026-08-02"},
  {"id":"f002","topic":"freshness :: median_asking_price :: fort_myers","fact":"Fort Myers median asking price (sourced 2026-08-02)","value":"324958.5 usd as of 2026-08-02, source SWFL Data Gulf active-listing inventory (https://www.swfldatagulf.com/desk).","src":"s01","date":"2026-08-02"},
  {"id":"f003","topic":"freshness :: median_asking_price :: naples","fact":"Naples median asking price (sourced 2026-08-02)","value":"650000 usd as of 2026-08-02, source SWFL Data Gulf active-listing inventory (https://www.swfldatagulf.com/desk).","src":"s01","date":"2026-08-02"},
  {"id":"f004","topic":"freshness :: mortgage_30yr_fixed :: swfl","fact":"SWFL 30-year fixed mortgage rate (sourced 2026-07-30)","value":"6.66 pct as of 2026-07-30, source FRED (https://fred.stlouisfed.org/series/MORTGAGE30US).","src":"s01","date":"2026-08-02"}
]
...
--- OUTPUT ---
{
  ...
  "key_metrics": [
    ...
    },
    {
      ...
      "value": 324958.5,
      "direction": "stable",
      "label": "Fort Myers median asking price (as of 2026-08-02)",
      "variable_type": "extensive",
      "units": "USD",
      "display_format": "currency",
      "source": {
        ...
        "fetched_at": "2026-08-02T04:23:36.086698+00:00",
        "tier": 2,
        "citation": "SWFL Data Gulf active-listing inventory — current median asking price for Fort Myers, sourced 2026-08-02"
      },
      "suggestions": [
        "Chart asking rents across the corridors",
    ...
    },
    {
      ...
      "value": 650000,
      "direction": "stable",
      "label": "Naples median asking price (as of 2026-08-02)",
      "variable_type": "extensive",
      "units": "USD",
      "display_format": "currency",
      "source": {
        ...
        "fetched_at": "2026-08-02T04:23:36.086698+00:00",
        "tier": 2,
        "citation": "SWFL Data Gulf active-listing inventory — current median asking price for Naples, sourced 2026-08-02"
      },
      "suggestions": [
        "Chart asking rents across the corridors",
...
--- RECENT NOTES ---
- 2026-08-02: pack refined by the Refinery — 4 fact(s) from 1 source(s).
```
