...
s01 | SWFL daily freshness layer — one cited current number per (metric, area) from a grounded live search (Gemini grounded → Firecrawl failsafe), provenance-gated to a real source URL, via Supabase data_lake.daily_truth (metric_key, area, period, value, unit, source_url, source_title, source_tag, verified_on_page, agreement_n, anomaly_flag, retrieved_at). | 2026-07-17 | 2026-07-18

--- SAVED FACTS ---
[
  {"id":"f001","topic":"freshness :: median_asking_price :: cape_coral","fact":"Cape Coral median asking price (sourced 2026-07-17)","value":"399999.5 usd as of 2026-07-17, source SWFL Data Gulf active-listing inventory (https://www.swfldatagulf.com/desk).","src":"s01","date":"2026-07-17"},
  {"id":"f002","topic":"freshness :: median_asking_price :: fort_myers","fact":"Fort Myers median asking price (sourced 2026-07-17)","value":"324250 usd as of 2026-07-17, source SWFL Data Gulf active-listing inventory (https://www.swfldatagulf.com/desk).","src":"s01","date":"2026-07-17"},
  {"id":"f003","topic":"freshness :: median_asking_price :: naples","fact":"Naples median asking price (sourced 2026-07-17)","value":"650000 usd as of 2026-07-17, source SWFL Data Gulf active-listing inventory (https://www.swfldatagulf.com/desk).","src":"s01","date":"2026-07-17"},
  {"id":"f004","topic":"freshness :: mortgage_30yr_fixed :: swfl","fact":"SWFL 30-year fixed mortgage rate (sourced 2026-07-16)","value":"6.55 pct as of 2026-07-16, source FRED (https://fred.stlouisfed.org/series/MORTGAGE30US).","src":"s01","date":"2026-07-17"}
]
...
--- OUTPUT ---
{
  ...
  "key_metrics": [
    ...
    },
    {
      ...
      "value": 324250,
      "direction": "stable",
      "label": "Fort Myers median asking price (as of 2026-07-17)",
      "variable_type": "extensive",
      "units": "USD",
      "display_format": "currency",
      "source": {
        ...
        "fetched_at": "2026-07-17T06:35:11.75111+00:00",
        "tier": 2,
        "citation": "SWFL Data Gulf active-listing inventory — current median asking price for Fort Myers, sourced 2026-07-17"
      },
      "suggestions": [
        "Chart asking rents across the corridors",
    ...
    },
    {
      ...
      "value": 650000,
      "direction": "stable",
      "label": "Naples median asking price (as of 2026-07-17)",
      "variable_type": "extensive",
      "units": "USD",
      "display_format": "currency",
      "source": {
        ...
        "fetched_at": "2026-07-17T06:35:11.75111+00:00",
        "tier": 2,
        "citation": "SWFL Data Gulf active-listing inventory — current median asking price for Naples, sourced 2026-07-17"
      },
      "suggestions": [
        "Chart asking rents across the corridors",
...
--- RECENT NOTES ---
- 2026-07-17: pack refined by the Refinery — 4 fact(s) from 1 source(s).
```
