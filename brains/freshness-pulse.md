<!-- FRESHNESS: v37 | Token: SWFL-7421-v37-20260809-bbd6095b -->
---
brain_id: freshness-pulse
version: 37
refined_at: 2026-08-09T04:30:18Z
freshness_token: SWFL-7421-v37-20260809-bbd6095b
ttl_seconds: 86400
...
s01 | SWFL daily freshness layer — one cited current number per (metric, area) from a grounded live search (Gemini grounded → Firecrawl failsafe), provenance-gated to a real source URL, via Supabase data_lake.daily_truth (metric_key, area, period, value, unit, source_url, source_title, source_tag, verified_on_page, agreement_n, anomaly_flag, retrieved_at). | 2026-08-09 | 2026-08-10

--- SAVED FACTS ---
[
  {"id":"f001","topic":"freshness :: mortgage_30yr_fixed :: swfl","fact":"SWFL 30-year fixed mortgage rate (sourced 2026-08-06)","value":"6.69 pct as of 2026-08-06, source FRED (https://fred.stlouisfed.org/series/MORTGAGE30US).","src":"s01","date":"2026-08-09"},
  {"id":"f002","topic":"freshness :: median_asking_price :: cape_coral","fact":"Cape Coral median asking price (sourced 2026-08-09)","value":"399900 usd as of 2026-08-09, source SWFL Data Gulf active-listing inventory (https://www.swfldatagulf.com/desk).","src":"s01","date":"2026-08-09"},
  {"id":"f003","topic":"freshness :: median_asking_price :: fort_myers","fact":"Fort Myers median asking price (sourced 2026-08-09)","value":"325000 usd as of 2026-08-09, source SWFL Data Gulf active-listing inventory (https://www.swfldatagulf.com/desk).","src":"s01","date":"2026-08-09"},
  {"id":"f004","topic":"freshness :: median_asking_price :: naples","fact":"Naples median asking price (sourced 2026-08-09)","value":"650000 usd as of 2026-08-09, source SWFL Data Gulf active-listing inventory (https://www.swfldatagulf.com/desk).","src":"s01","date":"2026-08-09"}
]
...
--- OUTPUT ---
{
  ...
  "version": 37,
  "refined_at": "2026-08-09T04:30:18Z",
  "expires": "2026-08-10T04:30:18Z",
  "ttl_seconds": 86400,
  "direction": "neutral",
  "magnitude": 0,
  "drivers": [],
  "overrides": [],
  "conclusion": "Today's sourced snapshot — SWFL 30-year fixed mortgage rate (as of 2026-08-06) 6.69%; Cape Coral median asking price (as of 2026-08-09) $399,900; Fort Myers median asking price (as of 2026-08-09) $325,000; Naples median asking price (as of 2026-08-09) $650,000. These are cited current facts only; the direction call lives downstream in master.",
  "key_metrics": [
    {
      ...
      "source": {
        ...
        "fetched_at": "2026-08-09T04:24:06.12482+00:00",
        "tier": 2,
    ...
    },
    {
      ...
      "value": 399900,
      "direction": "stable",
      "label": "Cape Coral median asking price (as of 2026-08-09)",
      ...
      "source": {
        ...
        "fetched_at": "2026-08-09T04:24:06.12482+00:00",
        "tier": 2,
        "citation": "SWFL Data Gulf active-listing inventory — current median asking price for Cape Coral, sourced 2026-08-09"
      },
      "suggestions": [
    ...
    },
    {
      ...
      "value": 325000,
      "direction": "stable",
      "label": "Fort Myers median asking price (as of 2026-08-09)",
      "variable_type": "extensive",
      "units": "USD",
      "display_format": "currency",
      "source": {
        ...
        "fetched_at": "2026-08-09T04:24:06.12482+00:00",
        "tier": 2,
        "citation": "SWFL Data Gulf active-listing inventory — current median asking price for Fort Myers, sourced 2026-08-09"
      },
      "suggestions": [
        "Chart asking rents across the corridors",
    ...
    },
    {
      ...
      "value": 650000,
      "direction": "stable",
      "label": "Naples median asking price (as of 2026-08-09)",
      "variable_type": "extensive",
      "units": "USD",
      "display_format": "currency",
      "source": {
        ...
        "fetched_at": "2026-08-09T04:24:06.12482+00:00",
        "tier": 2,
        "citation": "SWFL Data Gulf active-listing inventory — current median asking price for Naples, sourced 2026-08-09"
      },
      "suggestions": [
        "Chart asking rents across the corridors",
  ...
  "relevance": {
    "decay_curve": "weeks",
    "half_life_hours": 720,
    "computed_at": "2026-08-09T04:30:18Z"
  },
  "exogenous_signals": []
}
...
--- RECENT NOTES ---
- 2026-08-09: pack refined by the Refinery — 4 fact(s) from 1 source(s).
```
