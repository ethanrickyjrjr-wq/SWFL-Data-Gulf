# CPA / Audit Briefing: traffic-swfl
...
| --- | --- | --- | --- | --- | --- |
| T2 | Coastal SWFL (Lee + Collier + Charlotte) post-Ian recovery index, 2025 ÷ 2022 × 100 | 117.6 | rising | FDOT AADT segments via data_lake.fdot_aadt_fl (dlt-ingested from FDOT FTO_PROD/… | fixture://refinery/__fixtures__/traffic-swfl.sample.json |
| T2 | SWFL AADT 5-year CAGR (2021 → 2025, %) | 2.6 | rising | FDOT AADT segments via data_lake.fdot_aadt_fl (dlt-ingested from FDOT FTO_PROD/… | fixture://refinery/__fixtures__/traffic-swfl.sample.json |
| T2 | SWFL AADT YoY change 2024→2025, cohort-matched (%) | 4.2 | rising | FDOT AADT segments via data_lake.fdot_aadt_fl (dlt-ingested from FDOT FTO_PROD/… | fixture://refinery/__fixtures__/traffic-swfl.sample.json |
| T2 | SWFL length-weighted average AADT, year 2025 (vehicles/day) | 62804 | stable | FDOT AADT segments via data_lake.fdot_aadt_fl (dlt-ingested from FDOT FTO_PROD/… | fixture://refinery/__fixtures__/traffic-swfl.sample.json |
| T2 | SWFL median truck factor (TFCTR × 100), year 2025 | 7.2 | stable | FDOT AADT segments via data_lake.fdot_aadt_fl (dlt-ingested from FDOT FTO_PROD/… | fixture://refinery/__fixtures__/traffic-swfl.sample.json |
