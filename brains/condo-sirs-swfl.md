...
version: 1
refined_at: 2026-06-01T07:14:59Z
...
s01 | Florida DBPR SIRS Reporting Database — Lee + Collier; pre-July 2025 (app 14f1ed21) + July 2025+ (app d217126f); monthly Firecrawl scrape via https://dbpr-publicrecords.myfloridalicense.com/qpr/single/; data_lake.dbpr_sirs_submissions | 2026-06-01 | 2026-07-01

--- SAVED FACTS ---
[
  {"id":"f001","topic":"dbpr_sirs_snapshot","fact":"DBPR SIRS confirmed filings — Lee + Collier (positive signal only)","value":"Total SWFL confirmed: 239 (Lee: 80, Collier: 159). July 2025+ (HB 913 era): 230. Coverage flag: floor estimate. Latest scrape: 2026-06-01T07:09:31.079399+00:00.","src":"s01","date":"2026-06-01"}
]
...
--- OUTPUT ---
{
  ...
  "refined_at": "2026-06-01T07:14:59Z",
  "direction": "neutral",
  "magnitude": 0.8535714285714285,
  "drivers": [],
  "overrides": [],
  "conclusion": "DBPR confirms 239 SWFL condominium and cooperative associations have submitted their Structural Integrity Reserve Study as of 2026-06-01. Lee County: 80, Collier County: 159. Of these, 230 filed under the HB 913 compliance push (July 2025+ database). These counts are floor estimates — the Qlik hypercube limit fires before the full statewide registry renders. This is a positive-signal-only registry: presence confirms SIRS filing; absence cannot be interpreted without a baseline count of all SWFL 3-story+ condominiums.",
  "key_metrics": [
    {
    ...
    },
    {
      ...
      "source": {
        ...
        "fetched_at": "2026-06-01T07:14:58Z",
        "tier": 1,
        "citation": "DBPR SIRS Reporting Database — county_normalized=LEE rows: 80"
      }
    },
    {
      ...
      "source": {
        ...
        "fetched_at": "2026-06-01T07:14:58Z",
        "tier": 1,
        "citation": "DBPR SIRS Reporting Database — county_normalized=COLLIER rows: 159"
      }
    },
    {
      ...
      "source": {
        ...
        "fetched_at": "2026-06-01T07:14:58Z",
        "tier": 1,
        "citation": "DBPR SIRS Reporting Database — July 2025+ app (d217126f); database_period=july_2025_plus; Lee + Collier: 230. Represents post-HB 913 compliance push."
      }
    },
    {
      "metric": "sirs_result_truncated",
      "label": "Qlik Data Coverage — SIRS Registry",
      "value": "floor estimate (Qlik limit fired)",
      "direction": "stable",
      ...
      "source": {
        ...
        "fetched_at": "2026-06-01T07:14:58Z",
        "tier": 1,
        "citation": "DBPR SIRS Qlik apps — coverage flag set when 'Load more' visible at scrape end (Qlik hypercube limit). Current: \"floor estimate (Qlik limit fired)\"."
      }
    }
  ],
  "caveats": [
  ...
  "relevance": {
    "decay_curve": "weeks",
    "half_life_hours": 720,
    "computed_at": "2026-06-01T07:14:59Z"
  },
  "exogenous_signals": []
}
