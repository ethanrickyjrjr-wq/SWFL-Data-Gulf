# Franchise Consultant Briefing: cre-swfl
...
- **Median SWFL CRE cap rate (7 of 8 corridors)** — 6.5 ↓ _(source: [Brains Supabase corridor_profiles (verified, non-deleted) — median across 7 corridors reporting cap_rate_pct: Immokalee…](fixture://refinery/__fixtures__/corridor-profiles.sample.json), T2, fetched 2026-05-18T20:49:46Z)_
- **Median SWFL CRE vacancy rate (7 of 8 corridors)** — 6 ↓ _(source: [Brains Supabase corridor_profiles (verified, non-deleted) — median across 7 corridors reporting vacancy_rate_pct: Immok…](fixture://refinery/__fixtures__/corridor-profiles.sample.json), T2, fetched 2026-05-18T20:49:46Z)_
