...
- **Median SWFL CRE vacancy rate (21 of 25 corridors)** — 5.5 ↓ _(source: [Brains Supabase corridor_profiles (verified, non-deleted) — median across 21 corridors reporting vacancy_rate_pct: Immo…](https://jtkdowmrjaxfvwmemxso.supabase.co/rest/v1/corridor_profiles?select=*&verification_status=eq.verified&deleted_at=is.null&vacancy_rate_pct=not.is.null), T2, fetched 2026-05-17T02:49:24Z)_
