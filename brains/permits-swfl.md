<!-- FRESHNESS: v13 | Token: SWFL-7421-v13-20260603 -->
---
brain_id: permits-swfl
version: 13
refined_at: 2026-06-03T07:19:55Z
freshness_token: SWFL-7421-v13-20260603
ttl_seconds: 604800
...
s01 | Lee County Accela Citizen Access — building permit records (data_lake.lee_building_permits), scraped daily via Firecrawl. Portal: https://aca-prod.accela.com/LEECO/Cap/CapHome.aspx?module=Permitting&TabName=Permitting.                                                                                                   | 2026-06-03 | 2026-06-10
s02 | Collier County Building Permits — monthly XLSX reports (data_lake.collier_building_permits), scraped via Firecrawl stealth proxy + geocoded via Census batch API. Portal: https://www.colliercountyfl.gov/Business-Resources/Building-Permits-Construction/Meetings-Advisory-Boards-Reports/Monthly-Building-Permit-Reports. | 2026-06-03 | 2026-06-10

--- SAVED FACTS ---
[
  {"id":"f001","topic":"corpus_overview","fact":"SWFL building-permits corpus (Lee + Collier)","value":"5,003 permits (Lee 28, Collier 4,975) in trailing 63d window across 32 (corridor x bucket) cells. SWFL-weighted z = 0.00, SWFL saturation = 0.00.","src":"s01","date":"2026-06-03"}
]
...
--- OUTPUT ---
{
  ...
  "key_metrics": [
    ...
    },
    {
      ...
      "source": {
        ...
        "fetched_at": "2026-06-03T07:19:54Z",
        "tier": 1,
  ...
  "relevance": {
    "decay_curve": "weeks",
    "half_life_hours": 720,
    "computed_at": "2026-06-03T07:19:55Z"
  },
  "exogenous_signals": []
}
...
--- RECENT NOTES ---
- 2026-06-03: pack refined by the Refinery — 1 fact(s) from 2 source(s).
```
