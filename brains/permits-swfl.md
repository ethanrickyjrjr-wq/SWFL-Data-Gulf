<!-- FRESHNESS: v10 | Token: SWFL-7421-v10-20260530 -->
---
brain_id: permits-swfl
version: 10
refined_at: 2026-05-30T00:47:48Z
freshness_token: SWFL-7421-v10-20260530
ttl_seconds: 86400
...
s01 | Lee County Accela Citizen Access — building permit records (data_lake.lee_building_permits), scraped daily via Firecrawl. Portal: https://aca-prod.accela.com/LEECO/Cap/CapHome.aspx?module=Permitting&TabName=Permitting.                                                                                                   | 2026-05-30 | 2026-05-31
s02 | Collier County Building Permits — monthly XLSX reports (data_lake.collier_building_permits), scraped via Firecrawl stealth proxy + geocoded via Census batch API. Portal: https://www.colliercountyfl.gov/Business-Resources/Building-Permits-Construction/Meetings-Advisory-Boards-Reports/Monthly-Building-Permit-Reports. | 2026-05-30 | 2026-05-31

--- SAVED FACTS ---
[
  {"id":"f001","topic":"corpus_overview","fact":"SWFL building-permits corpus (Lee + Collier)","value":"1,011 permits (Lee 11, Collier 1,000) in trailing 59d window across 15 (corridor x bucket) cells. SWFL-weighted z = 0.00, SWFL saturation = 0.00.","src":"s01","date":"2026-05-30"}
]
...
--- OUTPUT ---
{
  ...
  "key_metrics": [
    ...
    },
    {
      ...
      "value": 0,
      "direction": "stable",
      "label": "Collier permits - Waterside, residential - 90d vs trailing-365d z (n_current=13)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0,
      "direction": "stable",
      "label": "Collier permits - Vanderbilt, residential - 90d vs trailing-365d z (n_current=11)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0,
      "direction": "stable",
      "label": "Collier permits - Pine Ridge, residential - 90d vs trailing-365d z (n_current=14)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0,
      "direction": "stable",
      "label": "Collier permits - North Naples (Immokalee Rd), residential - 90d vs trailing-365d z (n_current=11)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0,
      "direction": "stable",
      "label": "Collier permits - East Trail (Naples), residential - 90d vs trailing-365d z (n_current=24)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0,
      "direction": "stable",
      "label": "Collier permits - East Naples, residential - 90d vs trailing-365d z (n_current=11)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0,
      "direction": "stable",
      "label": "Collier permits - Downtown Naples, residential - 90d vs trailing-365d z (n_current=4)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0,
      "direction": "stable",
      "label": "Collier permits - Airport-Pulling, residential - 90d vs trailing-365d z (n_current=11)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0,
      "direction": "stable",
      "label": "Collier permits - East Trail (Naples), demolition - 90d vs trailing-365d z (n_current=1)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
  ...
  "relevance": {
    "decay_curve": "weeks",
    "half_life_hours": 720,
    "computed_at": "2026-05-30T00:47:48Z"
  },
  "exogenous_signals": []
}
...
--- RECENT NOTES ---
- 2026-05-30: pack refined by the Refinery — 1 fact(s) from 2 source(s).
```
