<!-- FRESHNESS: v33 | Token: SWFL-7421-v33-20260717 -->
---
brain_id: permits-swfl
version: 33
refined_at: 2026-07-17T21:47:14Z
freshness_token: SWFL-7421-v33-20260717
ttl_seconds: 604800
...
s01 | Lee County Accela Citizen Access — building permit records (data_lake.lee_building_permits), scraped daily via Firecrawl. Portal: https://aca-prod.accela.com/LEECO/Cap/CapHome.aspx?module=Permitting&TabName=Permitting.                                                                                                   | 2026-07-17 | 2026-07-24
s02 | Collier County Building Permits — monthly XLSX reports (data_lake.collier_building_permits), scraped via Firecrawl stealth proxy + geocoded via Census batch API. Portal: https://www.colliercountyfl.gov/Business-Resources/Building-Permits-Construction/Meetings-Advisory-Boards-Reports/Monthly-Building-Permit-Reports. | 2026-07-17 | 2026-07-24

--- SAVED FACTS ---
[
  {"id":"f001","topic":"corpus_overview","fact":"SWFL building-permits corpus (Lee + Collier)","value":"5,265 permits (Lee 290, Collier 4,975) in trailing 142d window across 42 (corridor x bucket) cells. SWFL-weighted z = 0.69, SWFL saturation = 0.07.","src":"s01","date":"2026-07-17"}
]
...
--- OUTPUT ---
{
  ...
  "version": 33,
  "refined_at": "2026-07-17T21:47:14Z",
  "expires": "2026-07-24T21:47:14Z",
  "ttl_seconds": 604800,
  "direction": "neutral",
  "magnitude": 0.23154086655557563,
  "drivers": [],
  "overrides": [],
  "conclusion": "Lee permit flow reads modestly heating (county-weighted z = 0.41). Naples feed last refreshed 2026-04-30; current build excludes Collier from the SWFL rollup. Highest commercial-alteration heat: none. Coolest: none.",
  "key_metrics": [
    {
    ...
    },
    {
      ...
      "value": 0.879,
      "direction": "rising",
      "label": "Collier permits - Waterside, residential - 90d vs trailing-365d z (n_current=33)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0.693,
      "direction": "rising",
      "label": "Collier permits - North Naples (Immokalee Rd), residential - 90d vs trailing-365d z (n_current=37)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0.917,
      "direction": "rising",
      "label": "Collier permits - Airport-Pulling, residential - 90d vs trailing-365d z (n_current=32)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0.791,
      "direction": "rising",
      "label": "Collier permits - Vanderbilt, residential - 90d vs trailing-365d z (n_current=49)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0.295,
      "direction": "stable",
      "label": "Collier permits - East Naples, residential - 90d vs trailing-365d z (n_current=17)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0.756,
      "direction": "rising",
      "label": "Collier permits - Pine Ridge, residential - 90d vs trailing-365d z (n_current=34)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": -0.027,
      "direction": "stable",
      "label": "Collier permits - East Trail (Naples), residential - 90d vs trailing-365d z (n_current=13)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0.454,
      "direction": "stable",
      "label": "Collier permits - Downtown Naples, residential - 90d vs trailing-365d z (n_current=7)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 2.046,
      "direction": "rising",
      "label": "Collier permits - North Naples (Immokalee Rd), commercial_alteration - 90d vs trailing-365d z (n_current=2)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0.879,
      "direction": "rising",
      "label": "Collier permits - Waterside, commercial_alteration - 90d vs trailing-365d z (n_current=4)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0.411,
      "direction": "stable",
      "label": "Collier permits - ZIP 34120, residential - 90d vs trailing-365d z (n_current=121)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0.753,
      "direction": "rising",
      "label": "Collier permits - ZIP 34108, residential - 90d vs trailing-365d z (n_current=66)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0.414,
      "direction": "stable",
      "label": "Collier permits - ZIP 34117, residential - 90d vs trailing-365d z (n_current=56)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0.651,
      "direction": "rising",
      "label": "Collier permits - ZIP 34119, residential - 90d vs trailing-365d z (n_current=103)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0.295,
      "direction": "stable",
      "label": "Collier permits - ZIP 34114, commercial_alteration - 90d vs trailing-365d z (n_current=3)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0.212,
      "direction": "stable",
      "label": "Collier permits - ZIP 34110, commercial_alteration - 90d vs trailing-365d z (n_current=3)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0.645,
      "direction": "rising",
      "label": "Collier permits - ZIP 34109, residential - 90d vs trailing-365d z (n_current=72)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0.081,
      "direction": "stable",
      "label": "Collier permits - ZIP 34112, residential - 90d vs trailing-365d z (n_current=31)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0.674,
      "direction": "rising",
      "label": "Collier permits - ZIP 34105, residential - 90d vs trailing-365d z (n_current=47)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0.46,
      "direction": "stable",
      "label": "Collier permits - ZIP 34113, residential - 90d vs trailing-365d z (n_current=59)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0.435,
      "direction": "stable",
      "label": "Collier permits - ZIP 34104, residential - 90d vs trailing-365d z (n_current=31)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0.374,
      "direction": "stable",
      "label": "Collier permits - ZIP 34110, residential - 90d vs trailing-365d z (n_current=59)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0.64,
      "direction": "rising",
      "label": "Collier permits - ZIP 34116, residential - 90d vs trailing-365d z (n_current=35)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0.511,
      "direction": "rising",
      "label": "Collier permits - ZIP 34114, residential - 90d vs trailing-365d z (n_current=50)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0.329,
      "direction": "stable",
      "label": "Collier permits - ZIP 34134, residential - 90d vs trailing-365d z (n_current=9)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0.538,
      "direction": "rising",
      "label": "Collier permits - ZIP 34142, residential - 90d vs trailing-365d z (n_current=17)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0.587,
      "direction": "rising",
      "label": "Collier permits - ZIP 34104, commercial_alteration - 90d vs trailing-365d z (n_current=3)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 1.609,
      "direction": "rising",
      "label": "Collier permits - ZIP 34103, residential - 90d vs trailing-365d z (n_current=13)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 3.798,
      "direction": "rising",
      "label": "Collier permits - ZIP 34109, commercial_alteration - 90d vs trailing-365d z (n_current=7)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0.49,
      "direction": "stable",
      "label": "Collier permits - ZIP 34112, commercial_alteration - 90d vs trailing-365d z (n_current=2)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0.879,
      "direction": "rising",
      "label": "Collier permits - ZIP 34142, commercial_alteration - 90d vs trailing-365d z (n_current=4)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
    ...
    },
    {
      ...
      "value": 0.49,
      "direction": "stable",
      "label": "Collier permits - ZIP 34120, commercial_alteration - 90d vs trailing-365d z (n_current=2)",
      "variable_type": "intensive",
      "units": "z-score",
      "display_format": "ratio",
      "source": {
  ...
  "relevance": {
    "decay_curve": "weeks",
    "half_life_hours": 720,
    "computed_at": "2026-07-17T21:47:14Z"
  },
  "exogenous_signals": []
}
...
--- RECENT NOTES ---
- 2026-07-17: pack refined by the Refinery — 1 fact(s) from 2 source(s).
```
