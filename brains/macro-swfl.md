<!-- FRESHNESS: v28 | Token: SWFL-7421-v28-20260601 -->
---
brain_id: macro-swfl
version: 28
refined_at: 2026-06-01T04:22:52Z
freshness_token: SWFL-7421-v28-20260601
ttl_seconds: 86400
...
s01 | macro-florida brain — https://www.swfldatagulf.com/api/b/macro-florida                                                                                                                                                            | 2026-06-01 | 2026-06-02
s02 | BLS Local Area Unemployment Statistics (LAUS) via data_lake.bls_laus (https://api.bls.gov/publicAPI/v2/timeseries/data/; series prefixes LAUST12, LAUCN12071, LAUCN12021; measures 03/04/05/06; monthly, not seasonally adjusted) | 2026-06-01 | 2026-06-02

--- SAVED FACTS ---
[
  {"id":"f001","topic":"laus_lee_vs_fl","fact":"Lee County unemployment rate vs FL state baseline","value":"Lee County 4.9% vs FL state baseline 4.4% (gap: +0.5pp, 2026-M03, preliminary)","src":"s02","date":"2026-06-01"},
  {"id":"f002","topic":"laus_collier_vs_fl","fact":"Collier County unemployment rate vs FL state baseline","value":"Collier County 4.5% vs FL state baseline 4.4% (gap: +0.1pp, 2026-M03, preliminary)","src":"s02","date":"2026-06-01"},
  {"id":"f003","topic":"laus_fl_benchmark","fact":"FL LAUS state rate (denominator benchmark for gap math)","value":"FL state LAUS 4.4% (2026-M03) — macro-florida confidence 1.00","src":"s02","date":"2026-06-01"}
]
...
--- RECENT NOTES ---
- 2026-06-01: pack refined by the Refinery — 3 fact(s) from 2 source(s).
```
