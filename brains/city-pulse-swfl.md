<!-- FRESHNESS: v49 | Token: SWFL-7421-v49-20260805-ea80654c -->
---
brain_id: city-pulse-swfl
version: 49
refined_at: 2026-08-05T22:01:46Z
freshness_token: SWFL-7421-v49-20260805-ea80654c
ttl_seconds: 86400
...
s01 | SWFL city pulse — daily Anthropic web_search_20250305 current-events facts, LLM-distilled with citation enforcement, via Supabase data_lake.city_pulse (id, city, topic, fact, source_url, source_title, cited_text, captured_at, expires_at, run_at); 7 cities; topic-TTL'd | 2026-08-05 | 2026-08-06

--- SAVED FACTS ---
[
  {"id":"f001","topic":"city-pulse:summary","fact":"Live SWFL current-events signals","value":"117 non-expired signals across 11 cities (Fort Myers: 33, Naples: 31, Cape Coral: 23, North Naples: 6, Fort Myers Beach: 5, Marco Island: 5, Sanibel: 4, Golden Gate: 2, Bonita Springs: 4, Estero: 3, Lehigh Acres: 1).","src":"s01","date":"2026-08-05"},
  {"id":"f002","topic":"city-pulse:breaking","fact":"Fort Myers — breaking","value":"The U.S. State Department issued an advisory referencing SW Florida Burmese pythons as among concerns, dubbed 'Suitcase Invaders,' related to invasive species concerns in the Naples/Lee County/Everglades area (published Aug. 1, 2026). (source: https://www.news-press.com/story/money/2026/08/01/sw-florida-burmese-pythons-among-concerns-in-state-department-advisory-naples-lee-county-everglades/91089085007/)","src":"s01","date":"2026-08-05"},
...
--- OUTPUT ---
{
  ...
  "version": 49,
  "refined_at": "2026-08-05T22:01:46Z",
  "expires": "2026-08-06T22:01:46Z",
  "ttl_seconds": 86400,
  "direction": "neutral",
  "magnitude": 0,
  "drivers": [],
  "overrides": [],
  "conclusion": "SWFL city pulse as of 2026-08-05: 117 live current-events signals across 11 cities — Fort Myers (33), Naples (31), Cape Coral (23), North Naples (6), Fort Myers Beach (5), Marco Island (5), Sanibel (4), Golden Gate (2), Bonita Springs (4), Estero (3), Lehigh Acres (1). Most current: Fort Myers — The U.S. State Department issued an advisory referencing SW Florida Burmese pythons as among concerns, dubbed 'Suitcase Invaders,' related to invasive species concerns in the Naples/Lee County/Everglades area (published Aug. 1, 2026). These are current cited facts only; the cross-vertical read and any direction call live downstream in master.",
  "key_metrics": [
    {
      "metric": "signal_breaking_1",
      "value": "Fort Myers: The U.S. State Department issued an advisory referencing SW Florida Burmese pythons as among concerns, dubbed 'Suitcase Invaders,' related to invasive species concerns in the Naples/Lee County/Everglades area (published Aug. 1, 2026).",
      "direction": "stable",
  ...
  "relevance": {
    "decay_curve": "weeks",
    "half_life_hours": 720,
    "computed_at": "2026-08-05T22:01:46Z"
  },
  "exogenous_signals": []
}
...
--- RECENT NOTES ---
- 2026-08-05: pack refined by the Refinery — 9 fact(s) from 1 source(s).
```
