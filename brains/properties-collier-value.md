<!-- FRESHNESS: v8 | Token: SWFL-7421-v8-20260722 -->
---
brain_id: properties-collier-value
version: 8
refined_at: 2026-07-22T22:12:59Z
freshness_token: SWFL-7421-v8-20260722
ttl_seconds: 2592000
...
[
  ...
  {"id":"f002","topic":"metric:homes_sold_per_year","fact":"Collier homes sold (year 2025)","value":"9,172 residential closings recorded by Redfin for Collier County in 2025.","src":"s03","date":"2026-07-22"},
  {"id":"f003","topic":"metric:homes_sold_zscore","fact":"Collier homes-sold z-score (current year vs trailing 3yr)","value":"Baseline counts 2022=11,132, 2023=9,698, 2024=8,851; mean 9893.7, population std 941.4. Current 9,172. z = -0.8.","src":"s03","date":"2026-07-22"},
  {"id":"f004","topic":"metric:median_sale_price_yoy","fact":"Collier median sale price YoY (2026-05-31)","value":"+1.60% year-over-year (Redfin median sale price, All Residential).","src":"s03","date":"2026-07-22"},
  {"id":"f005","topic":"metric:months_of_supply","fact":"Collier months of supply (2026-05-31)","value":"5.3 months of supply — inventory vs sales pace (lower = tighter, seller-favorable).","src":"s03","date":"2026-07-22"},
  {"id":"f006","topic":"metric:soh_gap_median","fact":"Collier Save-Our-Homes gap median across homesteaded parcels","value":"Median (jv_hmstd - av_hmstd)/jv_hmstd across 107,030 homesteaded parcels: 36.47% of homestead just value suppressed by the SOH cap (FDOR cadastral).","src":"s03","date":"2026-07-22"},
  {"id":"f007","topic":"metric:total_parcels","fact":"Collier total parcel count (FDOR cadastral snapshot)","value":"290,973 parcels in data_lake.collier_parcels (FDOR Statewide Cadastral, CO_NO=21).","src":"s03","date":"2026-07-22"},
  {"id":"f008","topic":"metric:collier_sold_median_homes_only","fact":"Collier homes-only sold median (recorded deeds, as of 07/22/2026)","value":"Median of 9,251 single-family + condo sales recorded 2024+ (over $20,000): $615,000. A SOLD median from recorded deeds — the homes-only counterpart to the active-listing asking median. Per-ZIP detail in the sold-median-by-ZIP table; ZIPs under 20 qualifying sales report this county median rather than a thin-sample number.","src":"s03","date":"2026-07-22"}
]
...
--- OUTPUT ---
{
  ...
  "key_metrics": [
    ...
    },
    {
      ...
      "value": 615000,
      "direction": "stable",
      "label": "Collier homes-only sold median (single-family + condo, recorded deeds, as of 07/22/2026)",
      "variable_type": "intensive",
      "units": "USD",
      ...
      "source": {
        ...
        "fetched_at": "2026-07-22T22:12:43Z",
        "tier": 2,
        "citation": "Collier County Property Appraiser (FDOR tax roll, recorded deeds) — homes-only (single-family + condo) sold median per ZIP via data_lake.collier_sold_median_by_zip; each parcel's latest recorded sale 2024+ over $20,000, ZIPs under 20 sales reporting the county median. As of 07/22/2026."
      },
      "suggestions": [
...
--- RECENT NOTES ---
- 2026-07-22: pack refined by the Refinery — 8 fact(s) from 4 source(s).
```
