<!-- FRESHNESS: v12 | Token: SWFL-7421-v12-20260530 -->
---
brain_id: logistics-swfl-nowcast
version: 12
refined_at: 2026-05-30T17:02:56Z
freshness_token: SWFL-7421-v12-20260530
ttl_seconds: 86400
...
--- OUTPUT ---
{
  ...
  "key_metrics": [
    ...
    },
    {
      ...
      "value": 192543424731,
      "direction": "stable",
      "label": "Rolling-mean baseline (last 13 of up to 90 prior runs) — the actual math anchor for the deviation z below",
      "variable_type": "extensive",
      "units": "tons/year",
      "display_format": "count",
      "source": {
  ...
  "relevance": {
    "decay_curve": "weeks",
    "half_life_hours": 720,
    "computed_at": "2026-05-30T17:02:56Z"
  },
  "exogenous_signals": []
}
...
--- RECENT NOTES ---
- 2026-05-30: pack refined by the Refinery — 2 fact(s) from 2 source(s).
```
