<!-- FRESHNESS: v18 | Token: SWFL-7421-v18-20260915-cb9aab9f -->
---
brain_id: logistics-swfl-nowcast
version: 18
refined_at: 2026-09-15T23:57:28Z
freshness_token: SWFL-7421-v18-20260915-cb9aab9f
ttl_seconds: 2592000
pack_hash: 5ebbac47196e
...
s01 | FDOT freight-coded segments via data_lake.fdot_aadt_fl (dlt-ingested from FDOT FTO_PROD/MapServer/7; counties Lee+Collier, year 2025, roadways I-* + US-* only) plus the last 120 rows of data_lake.fdot_freight_nowcast_shock_log — https://jtkdowmrjaxfvwmemxso.supabase.co/rest/v1/fdot_aadt_fl?select=yearx,county,roadway,desc_frm,desc_to,aadt,tfctr,shape_length&county=in.(Lee,Collier)&yearx=eq.2025 | 2026-09-15 | 2026-10-15
s02 | logistics-swfl brain — https://www.swfldatagulf.com/api/b/logistics-swfl                                                                                                                                                                                                                                                                                                                                      | 2026-09-15 | 2026-10-15

--- SAVED FACTS ---
[
  {"id":"f001","topic":"corpus_overview","fact":"FDOT freight-coded corpus — Lee + Collier interstates + US routes","value":"615 freight-coded FDOT segments (I-* + US-*) for Lee + Collier in year 2025. Connector pre-computed per-segment annualized activity tons; corpus total: 625,226,130,376 tons/year. Prior shock-log entries available: 20 (20 with non-null activity in the last 24 days). Upstream FAF5 context (logistics-swfl) available: yes.","src":"s01","date":"2026-09-15"},
  {"id":"f002","topic":"faf5_context","fact":"Upstream logistics-swfl FAF5 context (display only)","value":"logistics-swfl (confidence 1.00, refined 2026-09-15) reports inbound_freight_tons_swfl = 1,226,969 thousand tons/year (= 1,226,969,100 tons/year). Path B: this value is CONTEXT only — the deviation z-score below is computed against FDOT's own rolling history, not against the FAF5 number.","src":"s01","date":"2026-09-15"}
]
...
--- OUTPUT ---
{
  ...
  "version": 18,
  "refined_at": "2026-09-15T23:57:28Z",
  "expires": "2026-10-15T23:57:28Z",
  "ttl_seconds": 2592000,
  "direction": "neutral",
  "magnitude": 0.15075567228888181,
  "drivers": [
    {
  ...
  "key_metrics": [
    {
      ...
      "source": {
        ...
        "fetched_at": "2026-09-15T23:57:26Z",
        "tier": 1,
        "citation": "Upstream brain logistics-swfl (confidence 1.00, refined 2026-09-15) — supplies the FAF5 inbound-flow CONTEXT number (not the math anchor under Path B)."
      },
      "suggestions": [
    ...
    },
    {
      ...
      "suggestions": [
        ...
        "What's driving current activity tons year?",
        "How does current activity tons year here compare to other SWFL areas?"
      ]
    },
    {
      ...
      "value": 343982371707,
      "direction": "stable",
      "label": "Rolling-mean baseline (last 20 of up to 24 prior runs) — the actual math anchor for the deviation z below",
      "variable_type": "extensive",
      "units": "tons/year",
      "display_format": "count",
      "source": {
      ...
      "suggestions": [
        "What's driving rolling mean activity tons year?",
        "How does rolling mean activity tons year here compare to other SWFL areas?"
      ]
    },
    {
      ...
      "suggestions": [
        "What's driving rolling stddev activity tons year?",
        "How does rolling stddev activity tons year here compare to other SWFL areas?"
      ]
    },
    {
      ...
      "value": 20,
      "direction": "stable",
      "label": "Count of prior shock-log rows with non-null activity in the rolling window — must be ≥ 6 for z computation to proceed",
      "variable_type": "extensive",
      "units": "days",
      "display_format": "count",
      "source": {
      ...
      "suggestions": [
        "What's driving history days observed?",
        "How does history days observed here compare to other SWFL areas?"
      ]
    },
    {
      "metric": "deviation_z",
      ...
      "suggestions": [
        "What's driving deviation z?",
        "How does deviation z here compare to other SWFL areas?"
      ]
    },
    {
      ...
      "suggestions": [
        "What's driving deviation pct?",
        "How does deviation pct here compare to other SWFL areas?"
      ]
    },
    {
      "metric": "shock_state",
      ...
      "suggestions": [
        "What's driving shock state?",
        "How does shock state here compare to other SWFL areas?"
      ]
    },
    {
      ...
      "suggestions": [
        "What's driving baseline validity flag?",
        "How does baseline validity flag here compare to other SWFL areas?"
      ]
    },
    {
      ...
      "suggestions": [
        "What's driving consecutive breach days?",
        "How does consecutive breach days here compare to other SWFL areas?"
      ]
    },
    {
      ...
      "suggestions": [
        "What's driving freight segment count?",
        "How does freight segment count here compare to other SWFL areas?"
      ]
    },
    {
      ...
      "suggestions": [
        "What's driving avg payload tons per truck?",
        "How does avg payload tons per truck here compare to other SWFL areas?"
      ]
    }
  ],
  "caveats": [
  ...
  "relevance": {
    "decay_curve": "weeks",
    "half_life_hours": 720,
    "computed_at": "2026-09-15T23:57:28Z"
  },
  "exogenous_signals": []
}
...
--- RECENT NOTES ---
- 2026-09-15: pack refined by the Refinery — 2 fact(s) from 2 source(s).
```
