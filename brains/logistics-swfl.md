<!-- FRESHNESS: v13 | Token: SWFL-7421-v13-20260520 -->
---
brain_id: logistics-swfl
version: 13
refined_at: 2026-05-20T07:42:54Z
freshness_token: SWFL-7421-v13-20260520
ttl_seconds: 2592000
...
s01 | FAF5.7.1 freight flows (ORNL/FHWA Cold Lane Parquet; years 2020,2021,2022,2023,2024; dms_dest=129 trade_type=1) — https://faf.ornl.gov/faf5/ | 2026-05-20 | 2026-06-19

--- SAVED FACTS ---
[
  {"id":"f001","topic":"corpus_overview","fact":"FAF5 inbound domestic freight corpus — SWFL zone 129, latest historical year","value":"12 inbound domestic flow rows landing in FAF zone 129 (Remainder of Florida = SWFL) in year 2024, summed from 7 distinct origin zones and 7 SCTG commodity classes. Imports (trade_type=2) and exports (trade_type=3) are intentionally excluded — separate brains will own those scopes if/when built.","src":"s01","date":"2026-05-20"},
  {"id":"f002","topic":"metric:inbound_freight_tons_swfl","fact":"Total inbound domestic freight tonnage landing in SWFL","value":"Total inbound domestic freight in year 2024: 12853.1K tons (thousand tons) across all origins and commodities.","src":"s01","date":"2026-05-20"},
  {"id":"f003","topic":"metric:inbound_freight_value_swfl_musd","fact":"Total inbound domestic freight value landing in SWFL","value":"Total inbound domestic freight value in year 2024: $11639.4M (millions USD) across all origins and commodities.","src":"s01","date":"2026-05-20"},
  {"id":"f004","topic":"top_origins","fact":"Top 3 origin zones by inbound tonnage","value":"Top 3 origins by tons in 2024: Tampa-St. Petersburg (FAF zone 123, FL) — 4411.1K tons / $1021.6M; Orlando (FAF zone 124, FL) — 2768.6K tons / $3783.7M; Miami (FAF zone 121, FL) — 2221K tons / $3876.7M.","src":"s01","date":"2026-05-20"},
  {"id":"f005","topic":"top_commodities","fact":"Top 3 commodity classes by inbound tonnage","value":"Top 3 commodities by tons in 2024: commodity_12 (SCTG 12) — 4704.3K tons / $310.1M; commodity_7 (SCTG 7) — 2747K tons / $8359.2M; commodity_17 (SCTG 17) — 2305.4K tons / $1391.3M.","src":"s01","date":"2026-05-20"}
]
...
--- OUTPUT ---
{
  ...
  "relevance": {
    "decay_curve": "weeks",
    "half_life_hours": 720,
    "computed_at": "2026-05-20T07:42:54Z"
  },
  "exogenous_signals": []
}
...
--- RECENT NOTES ---
- 2026-05-20: pack refined by the Refinery — 5 fact(s) from 1 source(s).
```
