...
brain_id: master
version: 2
refined_at: 2026-05-14T13:10:44Z
ttl_seconds: 604800
...
[
  ...
  {"id":"f004","topic":"franchise-outcomes :: chargeoff_summary","fact":"Every franchise brand in the dataset that recorded an SBA loan charge-off","value":"13 brands recorded at least one charge-off — 14 loans charged off in total. Worst performer by survival rate: The Grounds Guys (0% survival — 2 of 2 resolved loans charged off). Full list (loans charged off / total loans): The Grounds Guys (2/2); SOUTH BEACH TANNING COMPANY (1/1); Zoom Room (1/2); Pak Mail (Retail Center) (1/1); INTERIM HEALTHCARE (F/K/A INTERIM SERVICES/ME (1/1); DICKEY'S BARBECUE PIT (1/1); 4Ever Young (1/3); VomFASS (1/1); FOSTER'S GRILLE (1/1); ANYTIME FITNESS (1/1); Aire Serv (1/2); BURGERIM (1/2); Experimax f/k/a Experimac (1/1).","src":"s01","date":"2026-05-14"},
